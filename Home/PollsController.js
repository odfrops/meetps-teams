var myCtrl = ['$scope', 'AngularServices', function ($scope, AngularServices) {
    ...
    $scope.SavePoll = function (BroadcastLink, BroadcastID) {
        localStorage.setItem('BroadcastLink', BroadcastLink)
        localStorage.setItem('BroadcastStatus', 'ready')
        localStorage.setItem('BroadcastID', BroadcastID)
        localStorage.setItem('MeetingID', $scope.meetingID)
